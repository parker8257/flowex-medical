    ...
    <section id="how-we-work" className="py-24 px-4 relative">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative">
          ...
          <div className="hidden md:block absolute top-24 left-1/6 right-1/6 h-[2px] bg-gradient-to-r from-[#2563EB]/0 via-[#2563EB]/50 to-[#2563EB]/0" />
          ...
          {t.howWeWork.steps.map((step, index) => {
            ...
            return (
              <motion.div
                ...
                className="relative"
              >
                <div className="bg-[#121212] border border-[#2a2a2a] rounded-2xl p-8 h-full hover:border-[#2563EB]/30 transition-colors">
                  {/* Step number */}
